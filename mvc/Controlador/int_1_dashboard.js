...
async function initHome() {
  ...
  // Escuchar si alguien publica un nuevo voluntariado
  window.socket.on("voluntariado-actualizado", async (nuevoVol) => {
    console.log("📩 Nuevo voluntariado recibido por socket:", nuevoVol);
    await mostrarVoluntariadosHome(); // Recarga visual del dashboard
  });
}
